...
<body>
    ...
    <div class="row">
        <div id="banner" class="col-md-12 col-xs-12">
            <div class="banner-image-risc"></div>
            <div class="banner-text text-center">
                <img src="../assets/img/society logos/risc.png" height="100px" width="auto" alt="">
                <h1>RISC</h1>
                <p style="color: white;">ROBOTICS SOCIETY</p>
        ...
        <div class="container">
            <div class="row my-auto">
                ...
                <div class="col-lg-6 ">
                    ...
                    <p>RISC- Robotics and Intelligent Systems Club is the Robotics Society of IIT Bhubaneswar that aims to
                        provide a forum for the students to pursue and learn innovative technology. The Society
                        strives to improve in innovation, education and applied research in Robotics and Automation but working
                        in a fun-filled environment sharing knowledge, information, and ideas. RISC members have also undertaken several projects to provide an
                        opportunity for healthy student interaction. RISC also conducts a national robotics competition
                        YANTHRIX during WISSENAIRE, the techno-management fest of IIT Bhubaneswar.</p>
            ...
            try {
              $conn = new PDO("mysql:host=$servername;dbname=$database", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM happenings WHERE society = 'risc' AND status = 'approved' ORDER BY id DESC LIMIT 0, 5");
              $stmt->execute();
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="social-links">
                            <center>
                              <a href="https://www.instagram.com/risc.iitbbs/" class="instagram"><i class="fa fa-instagram"></i></a>
                              <a href="https://www.facebook.com/IIT-Bhubaneswar-Robotics-Club-RISC-115352149093439/" class="facebook"><i class="fa fa-facebook"></i></a>
                            </center>
                          </div>
                        </div>
                      </div>
        ...
        <div class="contactdetails">
            <div class="contact">
                <div class="row">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">VIDIT SRIVASTAVA</h5>
            ...
            <div class="contact2" id="c2">
                <div class="row justify-content-center">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Hrushikesh Joshi</h5>
                            <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
                            <p class="card-text"></p>
                            <center>
                                <a href="tel:9422811114" class="phone"><i class="fa fa-phone"></i></a>
                                <a href="mailto:20me02002@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
                            </center>
                        </div>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Ankita Dilip Chopade</h5>
                            <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
                            <p class="card-text"></p>
                            <center>
                                <a href="tel:7249076598" class="phone"><i class="fa fa-phone"></i></a>
                                <a href="mailto:20ce02010@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
                            </center>
                        </div>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Varad Dahake</h5>
                            <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
                            <p class="card-text"></p>
                            <center>
                                <a href="tel:9022019345" class="phone"><i class="fa fa-phone"></i></a>
                                <a href="mailto:20me02026@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
                            </center>
                        </div>
                    </div>
                </div>
