...
<body>
  ...
  <div class="row">
    <div id="banner" class="col-md-12 col-xs-12">
      <div class="banner-image-nakshatra"></div>
      <div class="banner-text text-center">
        <img src="../assets/img/society logos/nakshatra.png" height="100px" width="auto" alt="">
        <h1>NAKSHATRA</h1>
        <p style="color: white;">ASTRONOMY SOCIETY</p>
  ...
  <div class="back">
    <div class="container">
      <div class="row my-auto"><!-- contentChanged -->
        <div class="col-lg-6 text-center center ">
          <br>
          <br>

          <img src="../assets/img/Soc-Images/nakshatra(1).jpg" class="img-fluid"  width="500px" height="auto" alt="">
        ...
        <div class="col-lg-6 ">
          <div class="text-center">
            <br><br><!-- contentChanged -->
            <h2>About Us</h2>
          </div>
          <p>Nakshatra - the Astronomy society of IIT Bhubaneswar is a group of space enthusiasts,
            passionate about stargazing and the world above the clouds. Nakshatra strives to develop a liking for
            astronomy on the
            campus by giving you a
            dose of astronomical facts and speculations. Take a bite at their bi-monthly magazine, the 'Galactic Cafe'.
            From space trivia to space fantasies, the magazine
            covers it all. Join one of their stargazing sessions, where you would learn more about the night sky,
            hands-on. Rest assured, Nakshatra would inject a punch of knowledge and mystery while you are here at
            IIT Bhubaneswar.</p>
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            try {
              $conn = new PDO("mysql:host=$servername;dbname=$database", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM happenings WHERE society = 'nakshatra' AND status = 'approved' ORDER BY id DESC LIMIT 0, 5");
              $stmt->execute();
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="social-links">
                    <center>
                      <a href="https://www.instagram.com/nakshatra_iitbbs/" class="instagram"><i class="fa fa-instagram"></i></a>
                      <a href="https://www.facebook.com/nakshatraiitbbs" class="facebook"><i class="fa fa-facebook"></i></a>
                    </center>
                  </div>
                </div>
              </div>
            ...
            <div class="follow-other">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="other-links">
                    <img src="../assets/img/society logos/neuromancers.png" height="55px" width="55px" alt="">
                    <a href="neuromancers.php">NEUROMANCERS</a>
                  </div>
    ...
    <div class="contactdetails">
      <div class="contact">
        <div class="row">
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">YUVRAJ PRATAP SINGH</h5>
      ...
      <div class="contact2" id="c2">
        <div class="row justify-content-center"><!-- changedContent -->
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Lade Sabari Girish</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:6281393036" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20ec01014@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Aditya Vijay Burman</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:8459711731" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20me02035@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Aniket Singh</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:6299829508" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20me02004@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
        </div>
