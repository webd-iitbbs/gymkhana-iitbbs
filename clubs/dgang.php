...
<body>
  ...
  <div class="back">
    <div class="container">
      <div class="row ">
        <div class="col-lg-6 text-center center my-auto">
          <br><br>
          <img src="../assets/img/Soc-Images/dgang(1).jpg" class="img-fluid"  width="500px" height="auto" alt="">
        ...
        <div class="col-lg-6 ">
          ...
          <p>D-Gang, the dance society of IIT Bhubaneswar organizes a plethora of activities spanning
            over the whole academic year to provide the dance enthusiasts with profuse platforms to excel in this genre
            of cult.
            The annual workshop aims at helping students to explore their interests in various forms of dance ranging
            from Popping to
            Bharatnatyam. D-Gang is a hub for many stalwarts who unceasingly train themselves to express the depth of
            their emotions through dance every time they perform on
            stage, whether it be the Fresher’s Intro, Autumn Production, Annual Production, Foundation Day, Women’s day
            or EBSB.
          </p>
    ...
    <!--Happenings changed--------------->
        ...
        <div class="card" id="happenings">
          <div class="card-body">
            ...
            try {
              $conn = new PDO("mysql:host=$servername;dbname=$database", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM happenings WHERE society = 'dgang' AND status = 'approved' ORDER BY id DESC LIMIT 0, 5");
              $stmt->execute();
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title"><center>FOLLOW US ON</center></h5>
          <p class="card-text"></p>
      ...
      <div class="follow-other">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title"><center>OTHER SOCIETIES</center></h5>
            <p class="card-text"></p>
    ...
    <div class="contactdetails">
      <div class="contact">
        <div class="row">
          <div class="card" style="width: 18rem; ">
            <div class="card-body">
              <h5 class="card-title">L DEVI JEYASRI</h5>
      ...
      <div class="contact2" id="c2">
        <div class="row justify-content-center">
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Abhishek Prajapati</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:9827658720" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20ce01039@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Keerti Kamble</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:9380470368" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20ce02012@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Paidi Meghana</h5>
              <h6 class="card-subtitle mb-2 text-muted">GOVERNOR</h6>
              <p class="card-text"></p>
              <center>
                <a href="tel:7330716788" class="phone"><i class="fa fa-phone"></i></a>
                <a href="mailto:20me01052@iitbbs.ac.in" class="mail"><i class="fa fa-envelope"></i></a>
              </center>
            </div>
          </div>
        </div>
